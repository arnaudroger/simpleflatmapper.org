...
```
{ 1, name1, subs : [ {1, sub1}, {2, sub2} ]
{ 2, name2, subs : [ {3, sub3}, {4, sub4} ]
```
...
for example using jhe `JdbcMapperFactory` - it will be the same for all other except for POI where it's not yet supported.
